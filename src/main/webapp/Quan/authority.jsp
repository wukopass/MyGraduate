...
<table class="layui-table" lay-data="{url:'/authority/select.do', page:true, id:'pageTable',toolbar: '#myBar', parseData:fmtData, done: function(){autoFrame(${param.id})}}" lay-filter="tableBind">
    <thead>
    <tr>
        <th lay-data="{type:'checkbox'}"></th>
        <th lay-data="{type:'numbers'}">序号</th>
        <th lay-data="{field:'authorityname', width:80}">权限名称</th>
        <%--<th lay-data="{field:'roleName', width: 200}">角色</th>--%>
        <th lay-data="{field:'description', width: 250}">邮箱</th>
        <th lay-data="{field:'url', sort: true, width: 180}">访问具体地址</th>
