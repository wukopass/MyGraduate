...
<body>
    ...
    <div id="all">
        ...
        <i id="midFour" class="mid"><img src="../images/demand/fbzcxq_1.png"></i>
        <i id="midFive" class="mid"><img src="../images/demand/fbgqjy.png"></i>
    </div>
        <div id="fmContext">
            <form id="fm1" action="${ctx}/saveAsset.do" method="post" enctype="multipart/form-data">
                <div style="margin: auto;width:50%;">
                    ...
                    <div class="compant">
                        <span class="fontCssOne">资产类型:</span>
                        <select class="select" id="assetType" name="assetType">

                        </select>
                    </div>

                    <div class="compant">
                        <span class="fontCssOne">资产估值:</span>
                    ...
                    <div class="compant">
                        <span class="fontCssOne">资产交易额:</span>
                        <input class="input" style="width:150px;" type="text" name="priceMin">---
                        <input class="input" style="width:150px;" type="text" name="priceMax">万元
                    </div>
                    ...
                    <div class="compant">
                        <span class="fontCssOne">转让范围:</span>
                        <input id="radioOne" type="radio" name="range" value="整体"><label class="fontTwo" for="radioOne">整体</label>
                        <input id="radioTwo" type="radio" name="range" value="部分"><label class="fontTwo" for="radioTwo">部分</label>
                    </div>
                    ...
                    <div class="compant" id="tipContext">
                        <span class="fontCssOne">资产描述:</span>
