        ...
        layui.use(['layer','laypage'], function() {
            ...
            function addContext(obj){
                ...
                str="<div style=\"width: 80%;margin:auto;margin-top:20px;\">" +
                    ...
                    "<span class=\"fontOne\">资产类型 :</span><span class=\"fontOne\">"+obj.assetType+"</span><br>" +
                    "<span class=\"fontOne\">发布时间 :</span><span class=\"fontOne\">"+obj.createTime+"</span><a class=\"proShow\" target=\"_blank\" href=\"/jsp/showAsset.jsp?id="+obj.id+"\">查看详情</a>" +
                    "</div>";
                $("#contexts").append(str);
            }
...
<body>
    ...
    <div id="all" style="background-color: #333333;">
        ...
        <div id="menu">
            ...
            <i class="menuI" style="background-color: #CC9966;">找资产</i>
            <i class="menuI" onclick="window.location.href='/jsp/findStock.jsp'">找股权</i>
        </div>

        <form id="fm1">
            <div class="compant">
                <span class="fontOne">资产类型:</span>
